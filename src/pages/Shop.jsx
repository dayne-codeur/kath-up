...
import "../styles/shop.css"; // Vérifie que la casse du dossier/fichier est exacte dans VS Code
  ...
  return (
    <main className="shop-page">
      <section className="shop-hero">
        ...
        <p>
          Découvre notre sélection de produits make-up, soins, onglerie et kits beauté.
        </p>
      </section>
      ...
      <section className="products-section">
        {filteredProducts.length > 0 ? (
          ...
          <div className="no-products">
            ...
            <p>Essaie avec un autre nom ou une autre catégorie.</p>
          </div>
        )}
      </section>
    </main>
